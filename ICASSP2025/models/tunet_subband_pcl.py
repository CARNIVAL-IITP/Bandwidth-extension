...
class BaseModel(pl.LightningModule):
    ...
    def forward_loss(self, x, y):
        if self.hparams.loss_type == 1:
            ...
            subband_loss1 = 0 * (subband_stft_loss_mg_1 + subband_stft_loss_sc_1)
            ...
            subband_loss8 = 1 * (subband_stft_loss_mg_8 + subband_stft_loss_sc_8)
...
class TUNet_subband_pcl(BaseModel):
    def __init__(self, train_dataset, val_dataset):
        super(TUNet_subband_pcl, self).__init__(train_dataset, val_dataset)
