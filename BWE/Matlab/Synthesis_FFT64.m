...
input_location = 'BWE_DB/FFT64/FEATURE/TEST/CLEAN/';
output_location = 'RESULT/original_mae/raws/';
parameter_location = 'MATLAB/FFT64/SYNTHESIS/';
mat_extension = '.mat';
txt_extension = '.txt';
...
% output = 'D:\projects\2016\»ï¼ºÀüÀÚ_µö·¯´×(¿Ï·á)\';
