...
input_location_feature = 'MATLAB/FFT64/NORMALIZE_MULTIPLE/REGRESSION1_DATASET2/'; %trainset2
%input_location_target = 'MATLAB/FFT64/NORMALIZE_MULTIPLE/TEST'; %testset
%output_location_feature = 'MATLAB/FFT64/SAVE_COST/DATASET1/';
output_location_feature = 'MATLAB/FFT64/SAVE_COST/DATASET2/';
%output_location_target = 'MATLAB/FFT64/SAVE_COST/TEST/';
