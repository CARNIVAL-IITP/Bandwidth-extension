...
class PLCModel(pl.LightningModule):
    def __init__(self, train_dataset = None, val_dataset = None, pred_ckpt_path = None, 
                 encoder_ckpt_path = None, version = None, save = None):
        ...
        # self.predictor = Predictor.load_state_dict(pred_ckpt_path)
        # checkpoint = torch.load(pred_ckpt_path)
        ...
        #     pred_checkpoint = torch.load(pred_ckpt_path)
        #     self.predictor = Predictor.load_state_dict(self=self.predictor, 
