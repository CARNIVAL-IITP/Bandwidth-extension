...
from models.traj_lstm import TrajLSTM
...
class Encoder_PLUS(pl.LightningModule):
...
class Predictor_PLUS(pl.LightningModule):  # mel
...
class RI_Predictor(pl.LightningModule):  # mel
