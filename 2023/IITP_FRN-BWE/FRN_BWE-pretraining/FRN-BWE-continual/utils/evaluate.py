import operator, os, time, librosa
import torch
...
from config_folder.confg_AudioUNet import CONFIG
# from config_folder.config_AFiLMNet import CONFIG
# from config_folder.config_TFiLMNet import CONFIG
# from config_folder.config_TUNet_MSM_clean import CONFIG
...
def evaluate_dataset(model, test_loader, sample_path,  version, cpu = False, single = False, save = False):
    ...
    out_path = current_path + '/output/' + CONFIG.DATA.dataset +'/version_' + str(version) + '/' + CONFIG.TASK.task 
