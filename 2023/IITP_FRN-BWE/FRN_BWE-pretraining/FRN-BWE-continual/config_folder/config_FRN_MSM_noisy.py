class CONFIG:
    ...
    class TASK:
        task = 'MSM-noisy'  # Task to execute. Should either be 'msm' or 'bwe'
    ...
    class DATA:
        ...
        data_dir = {'timit': {'root': '/home/donghyun2/Research/TUNet/data/TIMIT',
                    ...
                    'sitec': {'root': '/home/donghyun2/Research/TUNet/data/sitec',
                             'train': '/home/donghyun2/Research/TUNet/data/sitec/sitec_train.txt',
                             'test': '/home/donghyun2/Research/TUNet/data/sitec/sitec_test.txt'},
                    'sitec-rir-each': {'root': '/home/donghyun2/Research/TUNet/data/sitec_rir',
                             'train': '/home/donghyun2/Research/TUNet/data/sitec_rir/sitec_rir_each_tr.txt',
                             'test': '/home/donghyun2/Research/TUNet/data/sitec_rir/sitec_rir_each_test.txt',
                             'val' : '/home/donghyun2/Research/TUNet/data/sitec_rir/sitec_rir_each_val.txt'},
                    'sitec_rir_409': {'root': '/home/donghyun2/Research/TUNet/data/sitec_rir_409',
                             'train': '/home/donghyun2/Research/TUNet/data/sitec_rir_409/sitec_rir_409_train.txt',
                             'test': '/home/donghyun2/Research/TUNet/data/sitec_rir_409/sitec_rir_409_test.txt'}
                    }
    ...
    class LOG:
        ...
        log_dir = '/home/donghyun2/Research/FRN/FRN_BWE/FRN_BWE-pretraining/FRN-BWE-continual/outputs/SITEC_MSM-NB-fixed_FRN-baseline/'  # checkpoint and log directory
