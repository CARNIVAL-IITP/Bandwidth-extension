class CONFIG:
    ...
    class MODEL:
        ...
        afilm = True # enable/disable AFiLM layers
        ...
        # kernel_sizes = [65, 33, 17, 9]  # kernel sizes of each convolution/deconvolution layers
        # strides = [2, 2, 2, 2] # strides of each convolution/deconvolution layers
        # out_channels = [64, 128, 256, 512]  # numbers of filters of each convolution/deconvolution layers
    ...
    class TEST:
        in_dir = '/home/spteam/dh2/TUNet/data/sitec_rir_409/test_LPF/'  # path to test audio inputs
        out_dir = '/home/spteam/dh2/TUNet/output/sitec_409/'  # path to generated outputs
        ver = '4-6'